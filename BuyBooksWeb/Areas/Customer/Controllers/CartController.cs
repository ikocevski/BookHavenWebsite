...
namespace BuyBooksWeb.Areas.Customer.Controllers
{
    [Area("Customer")]
    [Authorize]
    public class CartController : Controller
    {
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            _emailSender.SendEmailAsync(orderHeader.ApplicationUser.Email, "New Order - Buy Book", "<p>New Order Created</p>");
